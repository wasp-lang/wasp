...
You can install mise by following the [official instructions](https://mise.jdx.dev/getting-started.html). Then, run `mise install` from the root of the repo to install all the required tools, after which you can access them in different ways:
