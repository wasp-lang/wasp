...
If you haven't migrated your app yet, follow the [migration instructions](/docs/0.15/migration-guide) and verify everything works. After that, come back here and try out the new Wasp TS config.
:::
