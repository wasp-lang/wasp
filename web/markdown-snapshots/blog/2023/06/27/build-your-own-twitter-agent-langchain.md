              ...
              <>
                ...
                <div key={tweetDraft.id} className='flex flex-col gap-2 justify-center items-center w-full'>
                  ...
                  <div className='flex flex-row gap-2 justify-center items-center w-full'>
                    <div className='w-full p-4 h-22 bg-blue-100 border rounded-lg'>{tweetDraft.content}</div>
                  </div>
                  ...
                  <div className='flex flex-col gap-2 justify-center items-center w-full'>
                    ...
                    {tweetDraft.originalTweet.ideas.map((idea) => (
                      <div key={idea.id} className='flex flex-row gap-2 justify-center items-center w-full'>
                        <div className='flex flex-row gap-2 justify-center items-center w-full'>
                          <div className='w-full p-4 h-22 bg-neutral-100 border rounded-lg'>{idea.content}</div>
                        </div>
                      </div>
                    ))}
                  </div>
      ...
      {notes && notes.length > 0 ? (
        notes.map((note) => (
          <div key={note.id} className='flex flex-col gap-2 justify-center items-center w-full'>
            <div className='flex flex-row gap-2 justify-center items-center w-full'>
              <div className='w-full p-4 h-22 bg-blue-100 border rounded-lg'>{note.content}</div>
            </div>
          </div>
        ))
      ) : notes && notes.length === 0 && (
        <div className='flex flex-col gap-2 justify-center items-center w-full'>
          <div className='w-full p-4 h-22 bg-blue-100 border rounded-lg'>No notes yet</div>
        </div>
      )}
    </>
  );
