      ...
      <div className='grid grid-cols-12'>
        ...
        <div className='col-span-12 lg:col-span-4'>
          ...
          <p className='text-neutral-700'>
            Given a simple <code>.wasp</code> configuration file that describes the high-level details of your web app, and <code>.js(x)/.css/...</code>, source files that describe the rest of your web app, Wasp compiler generates the full source of your web app in the target stack: front-end, back-end and deployment. <br/><br/>
