...
const Waspeteers = () => (
  <SectionContainer>
    ...
    <div className="mt-6 grid grid-cols-1 gap-3 lg:grid-cols-[260px_1fr]">
      <div className="relative flex flex-col items-center justify-center border-2 border-wasp-black bg-wasp-yellow-light p-5 text-center">
        <div className="absolute left-5 top-5 font-mono text-sm font-bold text-wasp-black">
          // meet da boi
        </div>
        <img
        ...
        />
        <div className="mt-3 font-mono text-xs text-wasp-g7">
      ...
      <div className="flex flex-col justify-center gap-4 p-5 lg:p-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            to="https://github.com/wasp-lang/wasp"
            className="inline-flex w-fit items-center gap-2 border-2 border-wasp-black bg-wasp-white px-5 py-2 font-mono text-sm font-bold text-wasp-black transition duration-200 ease-out hover:bg-wasp-yellow-light hover:text-wasp-black"
          >
