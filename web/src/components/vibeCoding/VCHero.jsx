...
const ActionButtons = () => (
  <div className="flex items-center justify-center gap-4">
    <Link to="/docs/quick-start">
      <button
        className="inline-flex items-center space-x-2 rounded-none border border-neutral-300 bg-neutral-200 text-neutral-700 px-5 py-3 font-mono text-sm font-medium uppercase tracking-wider transition duration-200 ease-out hover:border-neutral-400"
      >
        <Terminal size={16} />
    ...
    <a href="#how-wasp-works">
      <button
        className="inline-flex items-center space-x-2 rounded-none border border-neutral-300 bg-neutral-100 px-5 py-3 font-mono text-sm font-medium uppercase tracking-wider text-neutral-700 transition duration-200 ease-out hover:border-neutral-400 hover:text-neutral-900"
      >
        <ChevronDown size={16} />
...
const VCHero = () => {
  return (
    <div className="relative">
      ...
      />
      <div className="relative mx-auto max-w-4xl px-6 py-28 text-center lg:py-30 z-[2] lg:py-40">
