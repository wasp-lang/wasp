...
Other great place to check is their documentation, which can be found [here](https://wasp.sh/docs/features/auth/overview). It covers most of what I said here, and even more (e.g. the awesome new [hooks](https://wasp.sh/docs/features/auth/hooks) that came with Wasp v0.14)
...
For more detailed information on using Auth hooks with Wasp, visit the [Wasp documentation](https://wasp.sh/docs/features/auth/hooks).
