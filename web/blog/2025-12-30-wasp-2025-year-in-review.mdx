...
- **Deployment docs rehaul** - New guides for [Coolify, CapRover](/docs/deployment/methods/self-hosted), and improved deployment story overall
- **[TypeScript config](/docs/0.20/general/wasp-ts-config) (experimental)** - Define your app in `main.wasp.ts` instead of the DSL, with full editor support out of the box. Soon to become the default.
...
- **[Slack Authentication](/docs/features/auth/social-auth/slack)** - New auth provider, next to Google, GitHub, Discord, and others
