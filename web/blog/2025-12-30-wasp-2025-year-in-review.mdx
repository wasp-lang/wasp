...
- **[TypeScript config](/docs/general/wasp-ts-spec) (experimental)** - Define your app in `main.wasp.ts` instead of the DSL, with full editor support out of the box. Soon to become the default.
