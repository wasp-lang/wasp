...
Here's a 30-second video to showcase how simple it is to deploy a Wasp app to Railway - it takes a single CLI command and ~3 minutes!
...
For more details on deploying your Wasp apps with Railway, check out our [deployment documentation](/docs/deployment/methods/wasp-deploy/railway).
