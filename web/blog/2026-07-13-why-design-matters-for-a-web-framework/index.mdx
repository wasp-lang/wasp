...
<LandingPagesGrid
    images={[
      { source: "img/wasp-rebrand/alpha-landing-atf.png", alt: "Wasp's first proper landing page from the Alpha launch in March 2021" },
      { source: "img/wasp-rebrand/current-wasp-sh.png", alt: "Today's wasp.sh hero after the 2026 rebrand" }
    ]}
...
<LandingPagesCarousel
    images={[
      {
        source: "img/wasp-rebrand/stic-landing-page.png",
      ...
      {
        source: "img/wasp-rebrand/alpha-landing-atf.png",
      ...
      {
        source: "img/wasp-rebrand/pre-rebrand-landing-atf.png",
      ...
      {
        source: "img/wasp-rebrand/current-wasp-sh.png",
        label: "Today, 2026",
...
<ImgWithCaption
    ...
    source="img/wasp-rebrand/matija-nano-banana-mockup.png"
