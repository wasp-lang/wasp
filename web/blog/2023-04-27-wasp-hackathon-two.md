...
<div style={{ textAlign: "center", width: "100%", height: "400px", display: "inline-block" }}>
  <iframe height="100%" width="100%" src="https://www.youtube.com/embed/ts2mQHLBnc0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true" />
</div>
...
<ImgWithCaption width="30%" caption="Launch Week #2 Features -- YouTube Short" alt="Launch Week #2 Features -- YouTube Short" source="/img/hackathon2/lw2-short.png" />
...
<ImgWithCaption source="/img/lw2/wasp-saas-template.png" caption="Wasp SaaS Template w/ GPT, Stripe, and more 🎊" />
