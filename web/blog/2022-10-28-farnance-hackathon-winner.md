...
As such, we have updated our Deployment docs with new [recommendations](https://wasp-lang.dev/docs/advanced/deployment/overview).
:::
...
Wasp provides [step-by step instructions](/docs/advanced/deployment/overview) on how to do it with Netlify and Fly.io for free, but we plan to add even more examples and more integrated deployment experience in the coming releases!
