...
Today is a big day: we dropped our custom spec language and replaced it with a new, TypeScript-native way to define your full-stack app at a high level: the [TypeScript Spec](/docs/features/spec)!
...
You write the [Wasp TypeScript Spec (TS Spec)](/docs/features/spec) in `*.wasp.ts` files by constructing the `app` spec object.
