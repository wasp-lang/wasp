...
> — Leo, ex-marketer who built [Messync](https://messync.com)

<ImgWithCaption
  source="/img/lp/examples/messync.webp"
  caption="Messync — built by Leo, an ex-marketer with zero coding experience"
  alt="Messync app screenshot"
/>

> "If there was no Wasp, I don't think I would even start building this."
> — Sergio, 20-year backend veteran who built [CTOBox](https://ctobox.sergiovisinoni.com/)
