...
**Wasp features used**: [Social login with Google + auth UI](/blog/2023/04/12/auth-ui), [email sending](/docs/features/email)
...
**Wasp features used**: [Authentication](/docs/features/auth/overview), [email sending](/docs/features/email), [async/cron jobs](/docs/features/jobs)
...
**Wasp features used**:[Authentication](/docs/features/auth/overview), [async/cron jobs](/docs/features/jobs)
...
With our built-in deployment support (e.g. you can [deploy to Fly.io for free with a single CLI command](/docs/deployment/methods/wasp-deploy/fly)) the whole development process is extremely streamlined.
