...
1. [install Wasp](/docs/quick-start) with `npm i -g @wasp.sh/wasp-cli`
...
Consider that this code gives auth across your entire stack. So, not only do you get all the auth logic generated and managed for you on the server, but [you even get UI components and auth hooks](/docs/features/auth/ui) made available to you on the client!
