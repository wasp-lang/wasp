...
[Wasp](https://wasp.sh) is a full-stack framework for React, Node.js, and Prisma with batteries-included. Think Laravel-like productivity for the JS ecosystem but where authentication, routing, server functions, database, and cron jobs are defined declaratively as config. 
