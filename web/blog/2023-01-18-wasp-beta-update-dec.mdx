...
Next to [username/password](/docs/features/auth/username-and-pass/overview) and [Google](/docs/features/auth/social-auth/google), **Wasp now also supports [GitHub](/docs/features/auth/social-auth/github)** as an authentication method!
...
For more details, check the docs [here](/docs/features/auth/social-auth/github).
