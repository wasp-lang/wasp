...
This is the whole reason we keep going on about the spec being a first-class, programmable thing. It means that file-based routing didn't have to become a Wasp feature with a dozen options and an opt-out. It just became a small file you can control. [Meta-meta-framework, anyone?](/blog/2026/06/15/wasp-typescript-spec#:~:text=What%20does%20this%20make%20Wasp%3A%20a%20meta%2Dmeta%2Dframework%3F)
