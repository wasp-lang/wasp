...
Wasp routing also supports [dynamic](/docs/features/routing#dynamic-segments) (`:id`) and [optional](/docs/features/routing#optional-segments) (`:id?`) segments. Written out in the spec by hand, they look like this:
