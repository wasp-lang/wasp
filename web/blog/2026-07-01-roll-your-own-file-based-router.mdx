...
Wasp routing also supports [dynamic](/docs/features/routes#dynamic-segments) (`:id`) and [optional](/docs/features/routes#optional-segments) (`:id?`) segments. Written out in the spec by hand, they look like this:
