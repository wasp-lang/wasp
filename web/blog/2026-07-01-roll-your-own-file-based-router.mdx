...
Wasp routing also supports [dynamic](/docs/pages-and-routes#dynamic-segments) (`:id`) and [optional](/docs/pages-and-routes#optional-segments) (`:id?`) segments. Written out in the spec by hand, they look like this:
