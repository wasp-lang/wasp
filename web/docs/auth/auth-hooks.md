...
Works with Used with <AuthPills providers={['email']} /> authentication.
...
Used with <AuthPills providers={['discord','github','google','keycloak']} /> authentication.
...
Used with <AuthPills providers={['email','username','discord','github','google','keycloak']} /> authentication.
