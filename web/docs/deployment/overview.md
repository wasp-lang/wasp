...
We'll show you different ways of how deploy your app in the [deployment methods](./methods/overview.md) section.
...
- Different deployment methods (using [Wasp's CLI](./methods/wasp-deploy/overview.md), [cloud services](./methods/cloud-providers.md), [self-hosting](./methods/self-hosted.md), etc.)
