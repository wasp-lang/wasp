...
Remember, if you have defined any other [client-side env variables](/docs/advanced/env-vars#defining-env-vars-in-development) in your project, make sure to add them to the command above when [building your client](/docs/deployment/env-vars#client-env-vars)
:::
