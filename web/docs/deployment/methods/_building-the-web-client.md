...
Remember, if you have defined any other [client-side env variables](../../advanced/env-vars.md#defining-env-vars-in-development) in your project, make sure to add them to the command above when [building your client](../env-vars.md#client-env-vars)
:::
