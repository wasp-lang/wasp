...
If you've added any [client-side environment variables](../../../advanced/env-vars#client-env-vars) to your app, pass them to the terminal session before running the `deploy` command, for example:
