...
Check out how to do it with [Fly](./deployment-methods/wasp-deploy/fly.md#fly-custom-domain) if you are using Fly.io or [Railway](./deployment-methods/wasp-deploy/fly.md#railway-custom-domain) if you are using Railway.
