...
<CardLink to="../guides/configuration/cors-multiple-domains" label="guide" title="Multiple Domains CORS" description="Configure CORS to support multiple domains in your Wasp application" />
