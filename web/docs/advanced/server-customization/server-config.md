...
In case you want to store some values for later use, or to be accessed by the [Operations](../../features/data/operations/overview) you do that in the `setupFn` function.
