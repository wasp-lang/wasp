...
To see how to protect specific pages (i.e., hide them from non-authenticated users), read the docs on [using auth](../overview).
...
<CardLink
  ...
  description="All the options for the keycloak auth method."
/>
