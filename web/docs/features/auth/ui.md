...
Read more about customizing the signup process like adding additional fields or extra UI in the [Auth Overview](./overview#customizing-the-signup-process) section.
