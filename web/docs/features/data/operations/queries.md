...
We instead recommend skipping ahead and only reading [the differences between Queries and Actions](./actions#differences-between-queries-and-actions), and consulting the [API Reference](#api-reference) as needed.
:::
...
In most cases, resources used in Queries will be [Entities](../entities.md).
...
- `options`
  ...
  so in the [client setup function](../../../advanced/client-customization/client-config.md#overriding-default-behaviour-for-queries).
