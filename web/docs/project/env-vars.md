...
<EnvVarsTable
  envVars={[
{ name: "REACT_APP_API_URL", type: "URL", isRequired: true, note: <>The client uses this as the server URL. This is set by Wasp in development, but required in production. Change it in development with <a href="../general/cli#project-commands"><code>wasp start --server-port</code></a> and <a href="../general/cli#project-commands"><code>--server-url</code></a>.</> }
]}
/>
...
{ name: "WASP_WEB_CLIENT_URL", type: "URL", isRequired: true, note: <>Server uses this value as your client URL in various features e.g. linking to your app in e-mails. This is set by Wasp in development, but required in production. Change it in development with <a href="../general/cli#project-commands"><code>wasp start --client-port</code></a> and <a href="../general/cli#project-commands"><code>--client-url</code></a>.</> },
