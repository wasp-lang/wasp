...
{ name: "WASP_WEB_CLIENT_URL", type: "URL", isRequired: true, note: <span>Server uses this value as your client URL in various features e.g. linking to your app in e-mails. Defaults to <code>http://localhost:3000</code> in development.</span> },
{ name: "WASP_SERVER_URL", type: "URL", isRequired: true, note: <span>Server uses this value as your server URL in various features e.g. to redirect users when logging in with OAuth providers like Google or GitHub. Defaults to <code>http://localhost:3001</code> in development.</span> },
