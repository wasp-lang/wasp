...
With Prisma, you define your application's data model in a `schema.prisma` file. Read more about how are Wasp Entities and Prisma models related on the [Entities](./entities.md) page.
