...
- By default, Wasp connects to the PostgreSQL dev database via port `5432`. If this port is already in use or unavailable, you can specify a custom port using the `WASP_DEV_DB_PORT` environment variable.
