...
To add more pages, you can add another route to your spec. You can even add parameters to the URL path, using [dynamic segments](../features/routing#dynamic-segments). Let's test this out by adding a new page:
