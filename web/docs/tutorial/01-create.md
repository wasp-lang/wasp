...
<img alt="Screenshot the Wasp minimal starter app" src={useBaseUrl('img/wasp-new-screenshot.png')} style={{ border: "1px solid #ccc", borderRadius: "var(--custom-border-radius)" }} />
