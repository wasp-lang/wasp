...
<TutorialAction step="prisma-user" action="apply-patch" />
...
<TutorialAction step="wasp-file-auth" action="apply-patch" />
...
<TutorialAction step="migration-add-user" action="migrate-db" />
...
<TutorialAction step="wasp-file-auth-routes" action="apply-patch" />
...
<TutorialAction step="login-page-initial" action="apply-patch" />
...
<TutorialAction step="signup-page-initial" action="apply-patch" />
...
<TutorialAction step="wasp-file-auth-required" action="apply-patch" />
...
<TutorialAction step="main-page-add-auth" action="apply-patch" />
...
<TutorialAction step="prisma-connect-task-user" action="apply-patch" />
...
<TutorialAction step="migration-connect-task-user" action="migrate-db" />
```sh
wasp db migrate-dev
```
...
<TutorialAction step="query-add-auth" action="apply-patch" />
...
<TutorialAction step="action-add-auth" action="apply-patch" />
...
<TutorialAction step="main-page-add-logout" action="apply-patch" />
