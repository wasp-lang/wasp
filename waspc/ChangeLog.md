...
- Upgraded React Router from v6 to v7. This brings new features like middleware support. The upgrade is backwards compatible for library usage. ([#3490](https://github.com/wasp-lang/wasp/pull/3490))
