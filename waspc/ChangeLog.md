...
- Upgraded the Docker base image from Alpine 3.20 to Alpine 3.23. If you have a custom Dockerfile that depends on Alpine-specific packages, verify compatibility. ([#3933](https://github.com/wasp-lang/wasp/pull/3989))
