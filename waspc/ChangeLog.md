...
- Upgraded React Router from v7 to v8. Bump `react-router` to `^8.0.1` in your `package.json`. The upgrade is backwards compatible. ([#4433](https://github.com/wasp-lang/wasp/pull/4433))
