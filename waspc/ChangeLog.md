...
- Wasp now validate your `tsconfig.json` before generating code. If something is off, you'll get a clear error message instead of a cryptic failure during compilation ([#3907](https://github.com/wasp-lang/wasp/issues/3907))
