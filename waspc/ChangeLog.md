...
- Added a `wasp show build` command that prints information about your app's current build: build type, generation time, generating Wasp version, and project dir size. With `--json`, it prints the same information as JSON. ([#4625](https://github.com/wasp-lang/wasp/pull/4625))
