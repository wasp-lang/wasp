...
- Removed the `.wasp/build` directory. Wasp now only uses `.wasp/out` for generated app, both in development and production mode. ([#3540](https://github.com/wasp-lang/wasp/pull/3540))
