...
- Fixed `routes.<Route>.build()`, `<Link>`, and `<NavLink>` dropping a route param whose value is the number `0` (e.g. `/tasks/:id` with `{ id: 0 }` produced `/tasks` instead of `/tasks/0`). ([#4897](https://github.com/wasp-lang/wasp/pull/4897))
