...
- Upgraded internal `morgan` to 1.12.1, which fixes ([GHSA-jxfw-x594-9x9m](https://github.com/advisories/GHSA-jxfw-x594-9x9m)). Unlike the 1.11 upgrade, Wasp's usage is affected: the generated server uses `morgan('dev')`, whose format includes the attacker-controlled `:url` token. ([#4881](https://github.com/wasp-lang/wasp/pull/4881))
