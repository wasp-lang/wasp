...
- Wasp now manages your app's URLs in development, so setting `WASP_SERVER_URL`, `WASP_WEB_CLIENT_URL`, or `REACT_APP_API_URL` yourself is now an error. Use `--client-url` and `--server-url` instead. ([#4692](https://github.com/wasp-lang/wasp/pull/4692), [#4827](https://github.com/wasp-lang/wasp/pull/4827))
