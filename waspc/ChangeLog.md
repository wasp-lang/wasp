...
- The `api` export from `wasp/client/api` now is just a function that wraps native `fetch` instead of an Axios instance. ([#3998](https://github.com/wasp-lang/wasp/pull/3998))
