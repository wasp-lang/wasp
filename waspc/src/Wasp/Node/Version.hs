...
checkUserNodeAndNpmMeetWaspRequirements = do
  ...
  where
    checkUserNodeVersion = checkUserToolVersion nodeCmd ["--version"] oldestWaspSupportedNodeVersion
    checkUserNpmVersion = checkUserToolVersion npmCmd ["--version"] oldestWaspSupportedNpmVersion
