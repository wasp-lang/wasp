    ...
    Nothing ->
      ...
      concat
        [ validateWasp spec,
          ...
          validateSsrOnlyForPublicPages spec,
...
validateSsrOnlyForPublicPages :: AppSpec -> [ValidationError]
validateSsrOnlyForPublicPages spec =
  [ GenericValidationError $
      "Page '" ++ pageName ++ "' has ssr: true but requires auth. SSR is only supported for public pages."
