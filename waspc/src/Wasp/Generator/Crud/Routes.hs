...
makeFullPath crudOperationName crudOperation = intercalate "/" [crudRouteInWaspRouter, getCrudOperationRouterRoute crudOperationName, getRoute crudOperation]

getCrudOperationRouterRoute :: String -> String
getCrudOperationRouterRoute crudOperationName = crudOperationName

crudRouteInWaspRouter :: String
crudRouteInWaspRouter = "crud"
