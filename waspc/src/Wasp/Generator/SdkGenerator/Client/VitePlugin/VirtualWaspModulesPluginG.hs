...
import Wasp.Generator.SdkGenerator.Client.VitePlugin.Common (clientEntryPointPath, getPrerenderPaths, routesEntryPointPath, ssrEntryPointPath, virtualFilesDirInViteDir, virtualFilesFilesDirInViteDir)
