    ...
    loginSignupFormComponentTmplData =
      object
        [ "onAuthSucceededRedirectTo" .= getOnAuthSucceededRedirectToOrDefault auth,
          ...
          "slackSignInPath" .= OAuth.providerLoginRoute slackAuthProvider,
          "discordSignInPath" .= OAuth.providerLoginRoute discordAuthProvider,
          "googleSignInPath" .= OAuth.providerLoginRoute googleAuthProvider,
          "keycloakSignInPath" .= OAuth.providerLoginRoute keycloakAuthProvider,
          "gitHubSignInPath" .= OAuth.providerLoginRoute gitHubAuthProvider,
          "microsoftSignInPath" .= OAuth.providerLoginRoute microsoftAuthProvider,
