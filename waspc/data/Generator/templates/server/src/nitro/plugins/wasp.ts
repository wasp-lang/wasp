...
// PRIVATE API
/**
 * Resolves once the app's server side is up: its jobs are registered{=# setupFn.isDefined =} and your
 * setup function has run{=/ setupFn.isDefined =}. Starts it if nothing else has (which the plugin
