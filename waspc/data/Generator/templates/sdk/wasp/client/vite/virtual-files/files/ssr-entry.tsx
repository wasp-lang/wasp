...
import clientAssets from "{= clientEntryPointPath =}?assets=client";
import ssrAssets from "{= ssrEntryPointPath =}?assets=ssr";
...
const prerenderedPaths = new Set<string>({=& prerenderPaths =});
