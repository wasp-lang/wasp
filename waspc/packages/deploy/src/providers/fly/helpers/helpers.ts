...
import { ensureWaspProjectDirInCmdIsAbsoluteAndPresent, waspSays } from '../../../helpers.js';

export function ensureDirsInFlyCmdAreAbsoluteAndPresent(thisCommand: Command): void {
