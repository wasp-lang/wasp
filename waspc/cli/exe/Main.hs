    ...
    unlines
      [ title "USAGE",
        ...
        cmd   "    start db [--image <image>]",
              ...
              "                          Optionally specify a custom Docker image with --image (default: postgres).",
  ...
  putStrLn $
    unlines
      [ title "USAGE",
        ...
        title "COMMANDS",
        cmd $ intercalate "\n" [
              "  start [--image <image>]   Alias for `wasp start db`.",
              "                            Starts managed development database for you.",
              "                            Optionally specify a custom Docker image (default: postgres)."
        ],
