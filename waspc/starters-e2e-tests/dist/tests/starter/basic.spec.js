...
test.describe("basic only", {
    tag: "@basic",
}, () => {
    function getTaskForm(page) {
        return page.locator("#create-task");
    }
    function getTasksSection(page) {
        return page
            .locator("section.card.flex.w-full.max-w-3xl.flex-col.gap-6.p-4.lg\\:p-6")
            .nth(1);
    }
    function getTagDialog(page) {
