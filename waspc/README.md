...
6. Run `./run test` to confirm that all the tests are passing. If needed, accept changes in the snapshot tests with `./run test:waspc:e2e:accept-all`. Check "Tests" for more info.
