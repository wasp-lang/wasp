...
We use [mise](https://mise.jdx.dev/) to manage our development tools (e.g. Haskell, Node, and code formatters). Follow the [Dev tooling](../CONTRIBUTING.md#dev-tooling) section of the root `CONTRIBUTING.md` to get them installed and available in your shell.
