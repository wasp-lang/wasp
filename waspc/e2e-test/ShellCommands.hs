...
setDbToPSQL = insertLineAtWaspFile "  db: { system: PostgreSQL }," 2

insertLineAtWaspFile :: String -> Int -> ShellCommandBuilder ShellCommand
insertLineAtWaspFile line atLineNumber =
  return $
    combineShellCommands
