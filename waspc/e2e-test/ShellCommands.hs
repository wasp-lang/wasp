...
data ShellCommandContext = ShellCommandContext
  { currentProjectName :: String,
    currentOutputDirAbsFp :: FilePath,
    goldenOutputDirAbsFp :: FilePath
  }
  deriving (Show)
...
combineMakeShellCommands commands context = combineShellCommands (map (\command -> command context) commands)

cdIntoCurrentProject :: MakeShellCommand
cdIntoCurrentProject context = "cd " ++ currentProjectName context
...
waspCliNew context = "wasp-cli new " ++ currentProjectName context
