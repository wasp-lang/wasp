...
function Layout({ children, isFallbackPage = false, clientEntrySrc }) {
	...
	return /* @__PURE__ */ jsx(StrictMode, { children: /* @__PURE__ */ jsxs("html", {
		...
		] }), /* @__PURE__ */ jsxs("body", { children: [/* @__PURE__ */ jsx("noscript", { children: "You need to enable JavaScript to run this app." }), shouldRenderContent ? children : null] })]
	}) });
}
function useShouldRenderContent(isFallbackPage) {
