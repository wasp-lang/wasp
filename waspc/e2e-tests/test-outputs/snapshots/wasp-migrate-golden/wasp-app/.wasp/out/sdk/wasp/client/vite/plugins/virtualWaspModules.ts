...
const resolveVirtualFiles = makeVirtualFilesResolver([
  ...
  { id: "virtual:wasp/client-runtime-bindings", load: getClientRuntimeBindingsTsContent },
...
function shouldRestartClient(
  ...
  const bindingsModuleId = virtualFiles.ids.get("virtual:wasp/client-runtime-bindings");
