...
import { createClientAuthHandler as createClientAuthHandler_0 } from '@wasp.sh/auth-clerk/client'
...
// PRIVATE API
export const defaultScheme: AuthSchemeName = 'clerk'
...
export const clientAuthHandlers: Partial<Record<AuthSchemeName, ClientAuthHandler>> = {
  'clerk': createClientAuthHandler_0(makeClientRuntime('clerk', ['REACT_APP_CLERK_PUBLISHABLE_KEY']), joinSchemeConfig(undefined, []) as Parameters<typeof createClientAuthHandler_0>[1]),
}
