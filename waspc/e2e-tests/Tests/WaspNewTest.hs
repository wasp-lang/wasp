...
waspNewTest =
  Test
    ...
    [ TestCase
        "create-minimal"
        (sequence [runCommand $ waspCliNew "wasp-app" minimalStarterTemplate]),
      TestCase
        "create-minimal-interactive"
        (sequence [runCommand $ waspCliNewInteractive "wasp-app" minimalStarterTemplate]),
      TestCase
        "create-basic"
        (sequence [runCommand $ waspCliNew "wasp-app" basicStarterTemplate]),
      TestCase
        "create-basic-interactive"
        (sequence [runCommand $ waspCliNewInteractive "wasp-app" basicStarterTemplate])
