...
const SubmissionForm = () => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      await submitProject(validatedData);
  ...
  return (
    <>
      ...
      <div
        className="relative mt-10 md:pt-6 px-3 sm:mt-0 sm:px-20 sm:mx-10 lg:w-1/2"
        id="submission"
      >
        <h2 className="text-2xl text-neutral-700 mb-5 mx-1 underline decoration-yellow-500">
          Submit a Project
        </h2>
