      ...
      {poll && (
        <div className='mt-4 flex flex-col gap-4'>
          {poll.options.map((option) => (
            <Card
              key={option.id}
              className='relative min-h-[130px] transition-all duration-300'
            >
              <div className='z-10'>
                <div className='mb-2'>
                  ...
                  <div className='mt-2 flex max-w-[75%] flex-wrap gap-2'>
                    {option.votes.map((username, idx) => {
                      ...
                      return (
                        <div
                          key={username}
                          className='flex items-center justify-center rounded-lg bg-gray-100 px-3 py-1 text-sm shadow'
                        >
              ...
              <div className='absolute right-5 top-5 z-10 rounded-lg bg-gray-100 p-2 text-sm font-semibold'>
