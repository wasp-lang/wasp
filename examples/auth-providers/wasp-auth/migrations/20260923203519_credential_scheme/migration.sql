...
CREATE TABLE "new_Session" (
    ...
    "credentialScheme" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    CONSTRAINT "Session_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Auth" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Session" ("expiresAt", "id", "issuedAt", "loginScheme", "userId") SELECT "expiresAt", "id", "issuedAt", "loginScheme", "userId" FROM "Session";
DROP TABLE "Session";
