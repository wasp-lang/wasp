...
export const WASP_CLIENT_URL = "http://localhost:3000";

/**
 * API-level specs against the server, plus one browser spec for the forms;
 * a single chromium project runs both.
 */
