 ...
 *   paste in.
 */
export declare function betterAuth<UserSignupFieldsRef = never>(config?: BetterAuthConfig<UserSignupFieldsRef>): BetterAuthProviderManifest<UserSignupFieldsRef>;
