...
import type { WaspAuthServerConfig } from "./types.js";
/**
 ...
 * at `/auth/<scheme>`.
 */
export declare const createServerAuthHandler: ServerAuthHandlerFactory<WaspAuthServerConfig, never, true, MethodProviderName>;
...
export type { EmailContent, GetPasswordResetEmailContentFn, GetVerificationEmailContentFn, OAuthData, OAuthProviderName, OnAfterEmailVerifiedHook, OnBeforeOAuthRedirectHook, WaspAuthRuntime, WaspAuthServerConfig, } from "./types.js";
