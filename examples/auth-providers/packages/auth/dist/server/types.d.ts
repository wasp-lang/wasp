import type { JsonValue, OAuthLoginData, ServerSpecOf, WaspServerRuntimeFor } from "@wasp.sh/auth-contract";
 ...
 */
export type OnAfterEmailVerifiedHook<User = unknown, Prisma = unknown> = (params: {
