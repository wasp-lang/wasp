...
export function MainPage() {
    ...
    return (<main style={{ maxWidth: 480, margin: "3rem auto", fontFamily: "system-ui" }}>
      ...
      <form onSubmit={async (e) => {
        ...
        <input value={description} onChange={(e) => setDescription(e.target.value)} placeholder="What needs doing?"/>
