 ...
 */
export { canManageSessions, canRevokeSessions, getAuthContractErrorCode, type AuthContractErrorCode, type AuthenticateResult, type AuthProvider, type ProviderIdentities, type RuntimeGrantName, type SessionManagingAuthProvider, type SubjectRef, type SupportsAllSessionsRevocation, type SupportsSessionIssuance, type SupportsSessionRevocation, type VerifiedSession, type WaspEmail, type WaspServerRuntime, type WaspSessions, } from '@wasp.sh/auth-contract';
/**
 ...
 */
export type AuthProviderSetupFn = NonNullable<import('@wasp.sh/auth-contract').ServerAdapterExtensions['setupFn']>;
