 ...
 */
export type FromRegisterPath<Path extends readonly string[], Fallback> = WalkRegisterPath<Register, Path, Fallback>;
type WalkRegisterPath<Current, Path extends readonly string[], Fallback> = Path extends readonly [infer Key extends string, ...infer Rest extends readonly string[]] ? Key extends keyof Current ? WalkRegisterPath<Current[Key], Rest, Fallback> : Fallback : Current;
/**
