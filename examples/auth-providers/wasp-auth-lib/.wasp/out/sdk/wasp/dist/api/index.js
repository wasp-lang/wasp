...
// PRIVATE API (sdk)
export function setSessionId(sessionId, authProviderId) {
 ...
 */
export function getLastAuthProviderId() {
    const providerId = storage.get(WASP_APP_LAST_AUTH_PROVIDER_ID_NAME);
 ...
 */
async function fetchSessionForCredential(providerId, credential) {
...
function buildExchangeUrl(providerId) {
 ...
 * until logout.
 */
export async function exchangeCredentialForSession(providerId, credential) {
